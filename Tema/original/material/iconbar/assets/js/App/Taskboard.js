(function (global, factory) {
    ...
    babelHelpers.createClass(Stage, [{
      ...
      value: function bindRenameBtn() {
        ...
        this.$renameBtn.on('click', function (e) {
          ...
          var $menu = $(_this2).closest('.dropdown-menu');
  ...
  function () {
    ...
    babelHelpers.createClass(Duedate, [{
      ...
      value: function getTpl(content) {
        return "<span class=\"task-badge task-badge-subtask icon md-calendar\">".concat(content, "</span>");
      }
    }]);
    return Duedate;
  }();
  ...
  function () {
    ...
    babelHelpers.createClass(Subtask, [{
      ...
      key: "getTpl",
      value: function getTpl(content) {
        return "<span class=\"task-badge task-badge-subtask icon md-format-list-bulleted\">".concat(content, "</span>");
      }
    }]);
    return Subtask;
  }();
  ...
  function () {
    ...
    babelHelpers.createClass(Attachment, [{
      ...
      key: "getTpl",
      value: function getTpl(content) {
        return "<span class=\"task-badge task-badge-attachments icon md-attachment-alt\">".concat(content, "</span>");
      }
    }]);
    return Attachment;
  }();
  ...
  function () {
    ...
    babelHelpers.createClass(Comment, [{
      ...
      key: "getTpl",
      value: function getTpl(content) {
        return "<span class=\"task-badge task-badge-comments icon md-comment\">".concat(content, "</span>");
      }
    }]);
    return Comment;
  }();
