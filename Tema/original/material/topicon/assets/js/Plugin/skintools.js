(function (global, factory) {
  ...
  if (window.localStorage) {
    ...
    var layout = 'topicon'; // const levelPaht = layout;
      ...
      var navbarFn = setInterval(function () {
        ...
        if (navbar.length > 0) {
          ...
          if (settings.navbar && settings.navbar !== 'primary') {
            navbar[0].className += settings.navbar === 'yellow' ? ' bg-yellow-700' : " bg-".concat(settings.navbar, "-600");
          }
        }
      }, 5);
    }
      ...
      document.addEventListener('DOMContentLoaded', function () {
        ...
        var Skintools = {
          ...
          navbarImprove: function navbarImprove(val, checked) {
            var change = function change($nav, value) {
              var bg = "bg-".concat(value, "-600");
